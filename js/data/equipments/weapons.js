const data_weapons = [
  ...
  },
  {
    ...
    category: "Simple Melee",
    name: "Dagger",
    damage: "1d4 + Strength or Dexterity modifier Piercing",
  ...
  },
  {
    ...
    category: "Simple Melee",
    name: "Handaxe",
    damage: "1d6 + Strength modifier Slashing, using Dexterity modifier instead if thrown",
  ...
  },
  {
    ...
    category: "Simple Melee",
    name: "Javelin",
    damage: "1d6 + Strength modifier Piercing, using Dexterity modifier instead if thrown",
  ...
  },
  {
    ...
    category: "Simple Melee",
    name: "Light Hammer",
    damage: "1d4 + Strength modifier Bludgeoning, using Dexterity modifier instead if thrown",
    properties: "Light, Thrown (Range 20/60)",
    mastery: "Nick",
    weight: "2 lb.",
    cost: "2 GP",
  ...
  // --- MARTIAL MELEE ---
  {
    ...
    name: "Battleaxe",
    damage: "1d8 + Strength modifier Slashing",
  ...
  },
  {
    ...
    category: "Martial Melee",
    name: "Glaive",
    damage: "1d10 + Strength modifier Slashing",
  ...
  },
  {
    ...
    category: "Martial Melee",
    name: "Greataxe",
    damage: "1d12 + Strength modifier Slashing",
  ...
  },
  {
    ...
    category: "Martial Melee",
    name: "Lance",
    damage: "1d10 + Strength modifier Piercing",
  ...
  },
  {
    ...
    category: "Martial Melee",
    name: "Maul",
    damage: "2d6 + Strength modifier Bludgeoning",
    properties: "Heavy, Two-Handed",
    mastery: "Topple",
    weight: "10 lb.",
    cost: "10 GP",
  ...
  },
  {
    ...
    category: "Martial Melee",
    name: "Morningstar",
    damage: "1d8 + Strength modifier Piercing",
    properties: "—",
    mastery: "Sap",
    weight: "4 lb.",
    cost: "15 GP",
  ...
  },
  {
    ...
    category: "Martial Melee",
    name: "Rapier",
    damage: "1d8 + Strength or Dexterity modifier Piercing",
    properties: "Finesse",
    mastery: "Vex",
    weight: "2 lb.",
    cost: "25 GP",
  ...
  },
  {
    ...
    category: "Martial Melee",
    name: "Scimitar",
    damage: "1d6 + Strengt or Dexterity modifier Slashing",
  ...
  },
  {
    ...
    category: "Martial Melee",
    name: "Shortsword",
    damage: "1d6 + Strength modifier or Dexterity Piercing",
    properties: "Finesse, Light",
    mastery: "Vex",
    weight: "2 lb.",
    cost: "10 GP",
  ...
  },
  {
    ...
    category: "Martial Melee",
    name: "Trident",
    damage: "1d8 + Strength modifier Piercing, using Dexterity modifier instead if thrown",
  ...
  },
  {
    ...
    category: "Martial Melee",
    name: "Whip",
    damage: "1d4 + Strength or Dexterity modifier Slashing",
  ...
  // --- MARTIAL RANGED ---
  {
    ...
    name: "Blowgun",
    damage: "1 + Dexterity modifier Piercing",
  ...
  },
  {
    ...
    category: "Martial Ranged",
    name: "Heavy Crossbow",
    damage: "1d10 + Dexterity modifier Piercing",
  ...
  },
  {
    ...
    category: "Martial Ranged",
    name: "Musket",
    damage: "1d12 + Dexterity modifier Piercing",
  ...
  ,{
    ...
    category: "Simple Melee",
    name: "Whisperfang",
    damage: "1d4 + Strength or Dexterity Piercing",
  ...
  ,{
    ...
    category: "Martial Melee",
    name: "Sun Blade",
    damage: "1d8 + Strength or Dexterity Slashing or Radiant, plus 1d8 Radiant if the target is Undead",
    properties: "Finesse, Versatile (1d10)",
    mastery: "Sap",
    weight: "3 lb.",
    cost: "???",
    description: `Vật phẩm này trông giống như một chuôi kiếm.
    <p><b><i>Blade of Radiance.</i></b> Trong khi nắm giữ chuôi kiếm, bạn có thể dùng một Bonus Action để khiến một lưỡi kiếm bằng ánh sáng thuần khiết xuất hiện hoặc biến mất. Nếu bạn có proficiency với Longsword hoặc Shortsword, bạn cũng có proficiency với vũ khí này.
    <p>Bạn nhận được +2 bonus vào các attack roll và damage roll thực hiện bằng vũ khí này.
    <p><b><i>Sunlight.</i></b> Lưỡi kiếm phát sáng của thanh kiếm tỏa ra ánh sáng mặt trời Bright Light trong bán kính 15 feet và Dim Light cho 15 feet tiếp theo. Trong khi lưỡi kiếm vẫn đang duy trì, bạn có thể thực hiện một Magic action để tăng hoặc giảm bán kính của Bright Light và Dim Light, mỗi loại 5 feet, tối đa 30 feet hoặc tối thiểu 10 feet cho mỗi loại`,
    passcode: 7429185301,
    locked: true
  }
];