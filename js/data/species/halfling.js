const data_species_halfling = [
    {
        id: "species_halfling"
        , type: "Species"
        , name: "Halfling"
        , description_text: `Cherished and guided by gods who value life, home, and hearth, halflings gravitate toward bucolic havens where family and community help shape their lives. That said, many halflings possess a brave and adventurous spirit that leads them on journeys of discovery, affording them the chance to explore a bigger world and make new friends along the way. Their size—similar to that of a human child—helps them pass through crowds unnoticed and slip through tight spaces.
        <p>Anyone who has spent time around halflings, particularly halfling adventurers, has likely witnessed the storied "luck of the halflings" in action. When a halfling is in mortal danger, an unseen force seems to intervene on the halfling's behalf. Many halflings believe in the power of luck, and they attribute their unusual gift to one or more of their benevolent gods, including Yondalla, Brandobaris, and Charmalaine. The same gift might contribute to their robust life spans (about 150 years).
        <p>Halfling communities come in all varieties. For every sequestered shire tucked away in an unspoiled part of the world, there's a crime syndicate like the Boromar Clan in the Eberron setting or a territorial mob of halflings like those in the Dark Sun setting.
        <p>Halflings who prefer to live underground are sometimes called strongheart halflings or stouts. Nomadic halflings, as well as those who live among humans and other tall folk, are sometimes called lightfoot halflings or tallfellows.`
        , description: {
    ...
    , {
        id: "feature_species_halfling_brave"
        , type: "Feature"
        , category: "Species"
        , conditions: {
    ...
    , {
        id: "feature_species_halfling_halfling_nimbleness"
        , type: "Feature"
        , category: "Species"
        , conditions: {
            species: "species_halfling"
    ...
    , {
        id: "feature_species_halfling_luck"
        , type: "Feature"
        , category: "Species"
        , conditions: {
            species: "species_halfling"
    ...
    , {
        id: "feature_species_halfling_naturally_stealthy"
        , type: "Feature"
        , category: "Species"
        , conditions: {
            species: "species_halfling"
